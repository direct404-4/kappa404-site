...
const TIMELINE = [
  { year: "01", title: "KAPPA404", text: "Identità orientata a progettare presenza digitale con impatto premium." },
  { year: "02", title: "Digital Architect", text: "Architetture web performanti e sistemi visuali coerenti con il brand." },
  { year: "03", title: "AI Automation", text: "Workflow intelligenti per accelerare produzione, lead flow e operatività." },
      ...
      <div className="container-main grid items-start gap-12 lg:grid-cols-[1.1fr_1fr]">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-white/76 md:text-lg">
            Opero da {CONTACT_INFO.base} con un approccio da digital lab: ogni esperienza parte dalla visione estetica e viene trasformata in
            infrastruttura concreta, misurabile e scalabile.
          </p>
          <p className="mt-4 max-w-2xl text-base leading-8 text-white/68 md:text-lg">
            L&apos;obiettivo non è creare pagine isolate ma costruire ecosistemi in cui design, AI e automazione lavorano insieme per posizionare il brand e
